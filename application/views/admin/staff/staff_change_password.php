                ...
                <div class="card ">
                    <div class="row">
                        ...
                        <div class="card-body py-5">
                            <form method="post" action="staff_change_password" enctype= multipart/form-data class="needs-validation" novalidate>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="hidden" name="staff_token" value="<?php echo $_GET['st']; ?>">
                                    </div>
                                </div>
