            ...
            <div class="page-breadcrumb">
                ...
                <div class="row">
                    ...
                    <div class="col-12 d-flex no-block align-items-center">
                        ...
                        <h4 class="page-title">Food dishes of <?php echo $res_name['name']; ?></h4>

                        <div class="ml-auto text-right">
                          <?php
                          if (in_array("add_food_dish", $admin_roles)){
                        ?>
                            <a href="<?php echo base_url(); ?>admin/add_restaurant_food_dish?id=<?php echo $res_name['id']; ?>" class="btn btn-primary"><i class="mdi mdi-plus-circle mr-2"></i>Add</a>
                        <?php } ?>
                        </div>
